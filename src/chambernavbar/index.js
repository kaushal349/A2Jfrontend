...
class ChamberNavbar extends Component {
  constructor() {
    super();
    this.state = {};
  }
        ...
        <nav className="navbar navbar-custom navbar-expand-lg navbar-dark ">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav justify-content-end w-100">
              ...
              <li className="nav-item active" href="/" style={{marginRight:"3%"}}>
...
export default connect(mapStateToProps,mapDispatchToProps)(ChamberNavbar);
